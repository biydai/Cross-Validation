...
#############################################################################
# comparison 1 : n = 100, p = 100, nbeta = 10, censoring = 10% , nfold = 10
#############################################################################
...
#plot lambda
png(filename= "sim_1_3_lambda.png")
...
plot(x = c, y = com_result1[1,],ylim = c(0, 0.2), type = "l",lwd = 2,main = maintitle,
...
#plot MSE ratio
png(filename= "sim_1_3_mse.png")
maintitle <- expression(paste("MSE Ratio"," vs the magnitude of non-zero ", beta, "s", sep = ""))
xlab <- expression(paste("the magnitude of non-zero ", beta, "s", sep = ""))
plot(x = c, y = mse_ratio[1,],ylim = c(0, 10), type = "l",lwd = 2,main = maintitle,
