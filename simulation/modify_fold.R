################################################
# modify function cv.coxnet in glmnet package: #
################################################

# so that ungroup will always be ungroup; 
# won't be automatically changed into grouped
...
assignInNamespace("cv.coxnet", mycv.coxnet, ns="glmnet")
