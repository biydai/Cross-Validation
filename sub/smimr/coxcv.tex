...
\par To overcome this drawback, an alternative approach was proposed by Verweij and Van Houwelingen\citep{Verweij1993}.  Their approach, which we describe in detail in Section~\ref{Sec:cox-cv-existing}, stabilizes the cross-validated log likelihood, enabling its use even when the number of subjects in each fold is small.  This approach has been widely used and is the default approach to cross-validation in many software programs, such as the R package {\tt glmnet} \citep{glmnet}.  Although this approach fixes the stability issue, we demonstrate here that in practice, it tends to behave conservatively in terms of model selection.
...
To address this issue, Verweij and Van Houwelingen\citep{Verweij1993} proposed an alternative method for cross-validation in Cox models:
\begin{equation}
  \label{eq:VVH}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[height= 14cm ]{figure_auc.png}
...
\bibitem{Tibshirani1997}
Tibshirani R.
\newblock The lasso method for variable selection in the {Cox} model.
\newblock \emph{Statistics in Medicine} 1997; 16(4): 385--395.

\bibitem{Fan2002}
Fan J and Li R.
\newblock Variable selection for {Cox's} proportional hazards model and frailty
  model.
\newblock \emph{The Annals of Statistics} 2002; 30(1): 74--99.

\bibitem{Verweij1993}
Verweij PJM and Van~Houwelingen HC.
\newblock Cross-validation in survival analysis.
\newblock \emph{Statistics in Medicine} 1993; 12(24): 2305--2314.

\bibitem{glmnet}
Friedman J, Hastie T and Tibshirani R.
\newblock Regularization paths for generalized linear models via coordinate
  descent.
\newblock \emph{Journal of Statistical Software} 2010; 33(1): 1--22.

\bibitem{Therneau1990}
Therneau TM, Grambsch PM and Fleming TR.
\newblock Martingale-based residuals for survival models.
\newblock \emph{Biometrika} 1990; 77(1): 147--160.

\bibitem{CoxRidge}
Perperoglou A.
\newblock \emph{{CoxRidge: Cox} models with dynamic ridge penalties}, 2015.
\newblock \urlprefix\url{https://CRAN.R-project.org/package=CoxRidge}.
\newblock R package version 0.9.2.

\bibitem{fastcox}
Yang Y and Zou H.
\newblock \emph{Fastcox: {L}asso and elastic-net penalized {Cox's} regression
  in high dimensions models using the cocktail algorithm}, 2017.
\newblock \urlprefix\url{https://CRAN.R-project.org/package=fastcox}.
\newblock R package version 1.1.3.

\bibitem{SGL}
Simon N, Friedman J, Hastie T et~al.
\newblock \emph{{SGL: Fit} a {GLM} (or {Cox} model) with a combination of lasso
  and group lasso regularization}, 2018.
\newblock \urlprefix\url{https://CRAN.R-project.org/package=SGL}.
\newblock R package version 1.2.

\bibitem{CoxBoost}
Binder H.
\newblock \emph{{CoxBoost: Cox} models by likelihood based boosting for a
  single survival endpoint or competing risks}, 2013.
\newblock \urlprefix\url{https://CRAN.R-project.org/package=CoxBoost}.
\newblock R package version 1.4.

\bibitem{mboost}
Hothorn T, B\"uhlmann P, Kneib T et~al.
\newblock \emph{{mboost}: {M}odel-based boosting}, 2018.
\newblock \urlprefix\url{https://CRAN.R-project.org/package=mboost}.
\newblock {R} package version 2.9-1.
...
\newblock \emph{Annals of Applied Statistics} 2011; 5(1): 232--253.

\bibitem{Parker2007}
Parker BJ, G\"unter S and Bedo J.
\newblock Stratification bias in low signal microarray studies.
\newblock \emph{BMC Bioinformatics} 2007; 8: 326.

\bibitem{Simon2011a}
Simon RM, Subramanian J, Li MC et~al.
\newblock Using cross-validation to evaluate predictive accuracy of survival
  risk classifiers based on high-dimensional data.
\newblock \emph{Briefings in Bioinformatics} 2011; 12(3): 203--214.
\newblock \doi{10.1093/bib/bbr001}.

\bibitem{Subramanian2011}
Subramanian J and Simon R.
\newblock An evaluation of resampling methods for assessment of survival risk
  prediction in high-dimensional settings.
\newblock \emph{Statistics in Medicine} 2011; 30(6): 642--653.
\newblock \doi{10.1002/sim.4106}.

\bibitem{Therneau2018}
Therneau T, Atkinson B and Ripley B.
\newblock \emph{{rpart: Recursive} partitioning and regression trees}, 2018.
\newblock \urlprefix\url{https://CRAN.R-project.org/package=rpart}.

\bibitem{Breslow1972}
Breslow N.
\newblock Discussion following ``{R}egression models and life-tables''.
\newblock \emph{Journal of the Royal Statistical Society Series B
  (Methodological)} 1972; 34(2): 187--220.

\bibitem{Kalbfleisch2011}
Kalbfleisch JD and Prentice RL.
\newblock \emph{The statistical analysis of failure time data}.
\newblock Wiley Series in Probability and Statistics, John Wiley \& Sons, 2011.

\bibitem{R}
{R Core Team}.
\newblock \emph{{R: A} language and environment for statistical computing}.
\newblock R Foundation for Statistical Computing, Vienna, Austria, 2017.
\newblock \urlprefix\url{https://www.R-project.org/}.

\bibitem{VanHouwelingen2011}
Van~Houwelingen H and Putter H.
\newblock \emph{Dynamic prediction in clinical survival analysis}.
\newblock CRC Press, 2011.

\bibitem{HarrellJr1984}
Harrell FE, Lee KL, Califf RM et~al.
\newblock Regression modelling strategies for improved prognostic prediction.
\newblock \emph{Statistics in medicine} 1984; 3(2): 143--152.

\bibitem{shedden2008gene}
Shedden K, Taylor JMG, Enkemann SA et~al.
\newblock Gene expression--based survival prediction in lung adenocarcinoma: a
  multi-site, blinded validation study.
\newblock \emph{Nature Medicine} 2008; 14(8): 822.

\bibitem{Zou2005}
Zou H and Hastie T.
\newblock Regularization and variable selection via the elastic net.
\newblock \emph{Journal of the Royal Statistical Society: Series B
  (Methodological)} 2005; 67: 301--320.

\bibitem{Chen2009c}
Chen J, Bardes EE, Aronow BJ et~al.
\newblock {ToppGene Suite} for gene list enrichment analysis and candidate gene
  prioritization.
\newblock \emph{Nucleic Acids Research} 2009; 37: 305--311.
\newblock \doi{10.1093/nar/gkp427}.

\bibitem{Peretti2015}
Peretti M, Angelini M, Savalli N et~al.
\newblock Chloride channels in cancer: {F}ocus on chloride intracellular
  channel 1 and 4 ({CLIC1} and {CLIC4}) proteins in tumor development and as
  novel therapeutic targets.
\newblock \emph{Biochimica et Biophysica Acta (BBA) - Biomembranes} 2015;
  1848(10, Part B): 2523--2531.
\newblock \doi{10.1016/j.bbamem.2014.12.012}.
