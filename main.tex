...
For the elastic net model with $\lam$ and $\alpha$ selected by the cross-validated linear predictor approach, 85 genes were selected.  Of those, 78 were well-annotated.  We carried out an enrichment analysis of these 78 genes using ToppGene \citep{Chen2009c}; the five most significantly enriched molecular functions are listed in Table~\ref{Tab:go}.
